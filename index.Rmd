...
m <- prophet(df=fb_train, seasonality.prior.scale = 0.1,yearly.seasonality=TRUE,changepoint.prior.scale = 0.01)
...
ts_ggplot(Forecast=ts(fb_forecast1$yhat), Testset=ts(fb_test$y))
...
naive.data <- naive(data.train, h = 30)
